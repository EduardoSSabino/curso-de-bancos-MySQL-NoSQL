-- Atores
 INSERT INTO atores (nome) VALUES ('Bred Pitt'); -- insertando dados na tabela atore dentro da coluna nome
 INSERT INTO atores (nome) VALUES ('Angelina Jolie');
 INSERT INTO atores (nome) VALUES ('Felicity Jones');

-- Generos
 INSERT INTO generos (genero) VALUES ('Comedia');-- insertando dados na tabela generos no campo genero
 INSERT INTO generos (genero) VALUES ('Terror');
 INSERT INTO generos (genero) VALUES ('Suspense');

-- Filmes
 INSERT INTO filmes (titulo, id_genero, valor) VALUES ('Tomb Raider', 3, 8.99);-- insertando dados na tabela filmes em varios campos
...
-- Clientes
 INSERT INTO clientes (nome, sobrenome, telefone, endereco) VALUES ('Pedro', 'Silva', '2344-3344', 'Rua 1, 34');-- insertando dados
...
-- Atores Filme
 INSERT INTO atores_filme (id_filme, id_ator, personagem) VALUES (1, 2, 'Lara Croft');-- insertando dados
...
-- Dvds
 INSERT INTO dvds (id_filme, quantidade) VALUES (1, 1);-- insertando dados
 INSERT INTO dvds (id_filme, quantidade) VALUES (2, 1);
 INSERT INTO dvds (id_filme, quantidade) VALUES (3, 1);

-- Emprestimos
 INSERT INTO emprestimos (data, id_cliente) VALUES ('2019-03-01', 1);-- insertando dados
 INSERT INTO emprestimos (data, id_cliente) VALUES ('2019-03-15', 2);
 INSERT INTO emprestimos (data, id_cliente) VALUES ('2019-06-05', 1);

-- Filmes Emprestimo
 INSERT INTO filmes_emprestimo (id_emprestimo, id_dvd) VALUES (1, 1);-- insertando dados
...
-- Devolucoes
 INSERT INTO devolucoes (id_emprestimo, data) VALUES (1, '2019-03-08');-- insertando dados
...
-- Filmes Devolucao
 INSERT INTO filmes_devolucao (id_devolucao, id_filme_imprestimo) VALUES (1, 1);-- insertando dados
