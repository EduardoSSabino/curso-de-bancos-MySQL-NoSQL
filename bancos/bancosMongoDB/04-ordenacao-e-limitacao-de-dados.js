...
db.inscricoes.find().sort({"aluno": 1}).pretty() // ordenando na ordem crescente

db.inscricoes.find().sort({"aluno": -1}).pretty() // ordenando na forma decrecente 

/*
 Limitando os resultados....
*/

db.inscricoes.find().sort({"aluno": 1}).limit(3).pretty() // ordenando os trÊs primeiros em ordem crescente
