...
db.inscricoes.update( // atualizando incricoes
	{"_id" : ObjectId("5d07ad35d4975e81d79dee18")}, // meu usuario que será atualizado
	{
		$set: { // definindo ovalor que sera atualizado
			"localizacao": { // meu campo que sera atualizado
				"endereco": "Avenida Zulmira Borba, 1978" // atualização
			}
		}
	}
)
	...
	{"_id" : ObjectId("5d07ad35d4975e81d79dee18")},
	{
		$set: {
			"localizacao": {
				...
				"coordinates": [-20.388008, -54.577545], // o nome "coordinates" é obrigatório
				"type": "Point" // type : point tambem é obrigatório
			}
		}
	}
)
...
db.inscricoes.createIndex(
	{
		"localizacao": "2dsphere"  // 2dsphere  =  2D
	}
)
	...
	[
		{
			$geoNear: {
				...
				"distanceField": "distancia.calculada", // distancia.calculada, estou criando campo dentro de outro campo
				"spherical": true, // afirmando que a terra é esférica
				"num": 4 // trazendo os quatros mais proximos da coordernadas do usuario
			}
		}
	]
)
