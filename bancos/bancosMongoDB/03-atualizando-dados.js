...
db.inscricoes.remove( // removendo 
	{
...
db.inscricoes.update(
	{"curso.nome": "Programação para internet"}, // filtro
	{
		$set: {
			"curso.nome": "Programação para Internet"
		}
	...
	{
		multi: true // passando os comanos acima para todos usuario que se encaixe no flltro
	}
)
...
db.inscricoes.update(
	...
	{
		$push: { // acrescentando um valor no array
			notas: 6.7
		}
	}
)
...
db.inscricoes.update(
	{"_id" : ObjectId("5d07a8d2d4975e81d79dee16")},
	{
		$push: {
			notas: {
				$each: [9.2, 5] // passando mais de um valor pro array
			}
		}
	}
)
