--Os procedimentos são um conjunto de instruções que ficam armazenados pré-compilados no servidor e agrupados por um nome, assim como as funções. Só que, diferente de funções, as stored procedures não retornam valores.
...
CREATE PROCEDURE nome_do_stored_procedure --criando procedure
[
